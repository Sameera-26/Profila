<template>
  <div class="flex justify-center">
    <div class="divide-y-2 divide-gray-300 bg-white rounded-xl max-w-xl w-full shadow-2xl my-32">
      ...
      <div class="pt-10 p-8">
        ...
        <div v-bind:class="{ hidden: openTab !== 2, block: openTab === 2 }">
          ...
          <div class="w-full pb-8 pt-5">
            <label class="block tracking-wide text-gray-100 text-xs font-bold mb-2"
              for="email">
              Email
            </label>
            <input
